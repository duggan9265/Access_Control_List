...
if { $list_projs eq "" } {
   create_project ACL ACL_proj -part xczu9eg-ffvb1156-2-e
...
\
  ...
  # Create port connections
  connect_bd_net -net ACLK_1 [get_bd_pins zusp_ps/pl_clk0] [get_bd_pins clk_75] [get_bd_pins axi_pl_ps/ACLK] [get_bd_pins axi_pl_ps/S00_ACLK] [get_bd_pins axi_pl_ps/S01_ACLK] [get_bd_pins axi_pl_ps/S02_ACLK] [get_bd_pins axi_pl_ps/M00_ACLK] [get_bd_pins ps_axi_periph/ACLK] [get_bd_pins ps_axi_periph/S00_ACLK] [get_bd_pins ps_axi_periph/S01_ACLK] [get_bd_pins ps_axi_periph/M00_ACLK] [get_bd_pins ps_axi_periph/M01_ACLK] [get_bd_pins ps_axi_periph/M02_ACLK] [get_bd_pins ps_rst_75/slowest_sync_clk] [get_bd_pins zusp_ps/maxihpm0_fpd_aclk] [get_bd_pins zusp_ps/maxihpm1_fpd_aclk] [get_bd_pins zusp_ps/saxihp0_fpd_aclk]
...
proc create_root_design { parentCell } {
  ...
  assign_bd_address -offset 0xE0000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces axi_eth_0_dma/Data_MM2S] [get_bd_addr_segs zynq_ps/zusp_ps/SAXIGP2/HP0_PCIE_LOW] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces axi_eth_0_dma/Data_MM2S] [get_bd_addr_segs zynq_ps/zusp_ps/SAXIGP2/HP0_QSPI] -force
  ...
  assign_bd_address -offset 0xE0000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces axi_eth_0_dma/Data_S2MM] [get_bd_addr_segs zynq_ps/zusp_ps/SAXIGP2/HP0_PCIE_LOW] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces axi_eth_0_dma/Data_S2MM] [get_bd_addr_segs zynq_ps/zusp_ps/SAXIGP2/HP0_QSPI] -force
  ...
  assign_bd_address -offset 0xE0000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces axi_eth_0_dma/Data_SG] [get_bd_addr_segs zynq_ps/zusp_ps/SAXIGP2/HP0_PCIE_LOW] -force
  ...
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces axi_eth_0_dma/Data_SG] [get_bd_addr_segs zynq_ps/zusp_ps/SAXIGP2/HP0_QSPI] -force
